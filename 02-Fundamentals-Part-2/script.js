...
// const interface = 'Audio'; // SyntaxError
// const private = 534; // SyntaxError

/* ******************************************************************************** */
// 33. Functions
function logger() { // to use multiple times
...
friendsArray[2] = 'Jay';
console.log(friendsArray);
// friendsArray = ['Bob', 'Alice'] // TypeError: constant variable

const firstName = 'Jonas';
const jonas = [firstName, 'Schmedtmann', 2037 - 1991, 'teacher', friendsArray];
console.log(jonas);
...
// console.log(jonasObject.'last' + nameKey) // SyntaxError
...
console.log(jonasNewObject.calcAge());
console.log(jonasNewObject.age);
console.log(jonasNewObject.age);
console.log(jonasNewObject.age);

// Challenge
// "Jonas is a 46-year old teacher, and he has a driver's license"
console.log(jonasNewObject.getSummary());
...
// console.log(jonasLoop[0])
// console.log(jonasLoop[1])
// ...
// console.log(jonasLoop[4])
// jonasLoop[5] does NOT exist
for (let i = 0; i < jonasLoop.length; i++) {
    // Reading from jonasLoop array
    console.log(jonasLoop[i], typeof jonasLoop[i]);

    // Filling types array
    // types[i] = typeof jonasLoop[i];
    types.push(typeof jonasLoop[i]);
}
...
for (let i = 0; i < jonasLoop.length; i++) {
    if (typeof jonasLoop[i] !== 'string') continue;
    console.log(jonasLoop[i], typeof jonasLoop[i]);
}
...
for (let i = 0; i < jonasLoop.length; i++) {
    if (typeof jonasLoop[i] === 'number') break;
    console.log(jonasLoop[i], typeof jonasLoop[i]);
}
...
const calcTipChallenge = function (bill) {
    return bill >= 50 && bill <= 300 ? bill * 0.15 : bill * 0.2;
}
const billsChallenge = [22, 295, 176, 440, 37, 105, 10, 1100, 86, 52];
const tipsChallenge = [];
const totalsChallenge = [];

for (let i = 0; i < billsChallenge.length; i++) {
    const tip = calcTipChallenge(billsChallenge[i]);
    tipsChallenge.push(tip);
    totalsChallenge.push(tip + billsChallenge[i]);
}

console.log(billsChallenge, tipsChallenge, totalsChallenge);
...
console.log(calcAverageChallenge([2, 3, 7]));
console.log(calcAverageChallenge(totals));
console.log(calcAverageChallenge(tips));
